// Heart Rate Dynamics Model for Bangle.js
// Auto-generated from trained model
// Performance: MAE 1.00 bpm
// Features: 7
// Buffer: 11 HR readings

class HRDynamicsModel {
  constructor() {
    this.coefficients = [4.068440810955901, 3.5646418433127876, -0.38642161107991546, 0.19183015811112056, 1.5671255187131818, 2.0255218264722794, 1.829923172740181];
    this.intercept = 76.97353854152331;
    this.scalerMean = [76.97425722892487, 76.9746930287322, 76.97603865620746, 76.97084728657278, -0.0004357998073306115, 76.97536125510345, 76.9741326054712];
    this.scalerScale = [11.76404316651141, 11.763329510524711, 11.763578657995888, 11.763757044005358, 3.783523818920127, 11.358927644678195, 11.142403197668143];
    this.features = ["hr_lag_1", "hr_lag_2", "hr_lag_5", "hr_lag_10", "hr_change_1", "hr_rolling_mean_5", "hr_rolling_mean_10"];
    this.bufferSize = 11;
    this.hrBuffer = [];
  }
